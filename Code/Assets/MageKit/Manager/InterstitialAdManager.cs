...
public class InterstitialAdManager : MonoBehaviour {
	...
	public void HandleOnAdLoaded(object sender, EventArgs args)
	{
		...
		ApiManager.instance.SendAppEvent ("InterstitialAdLoaded");
	}
	...
	public void HandleOnAdFailedToLoad(object sender, AdFailedToLoadEventArgs args)
	{
		...
		fade.SetActive (false);
		ApiManager.instance.SendAppEvent ("InterstitialAdFailtoLoaded");
	}

	public void HandleOnAdOpened(object sender, EventArgs args)
	{
		Debug.Log("HandleAdOpened event received");
		ApiManager.instance.SendAppEvent ("InterstitialAdOpened");
		Time.timeScale = 1;
	}
	...
	public void HandleOnAdClosed(object sender, EventArgs args)
	{
		...
		ApiManager.instance.SendAppEvent ("InterstitialAdClosed");
		fade.SetActive (false);
		Time.timeScale = 1;
	}
	...
	IEnumerator ShowAdCoroutine()
	{
		...
		#endif
		interstitial.Show ();
		ApiManager.instance.SendAppEvent ("InterstitialAdShow");
	}
