...
public class BannerAdManager : MonoBehaviour {
	...
	if (bannerView != null && !PurchaseManager.instance.IsRemoveAd ()) {
			bannerView.Show ();
			ApiManager.instance.SendAppEvent ("BannerAdShow");
		}
	}
	...
	public void HandleOnAdLoaded(object sender, EventArgs args)
	{
		...
		ApiManager.instance.SendAppEvent ("BannerAdLoaded");
		HideAd ();
	}
	...
	public void HandleOnAdOpened(object sender, EventArgs args)
	{
		...
		ApiManager.instance.SendAppEvent ("BannerAdOpened");
	}

	public void HandleOnAdClosed(object sender, EventArgs args)
	{
		Debug.Log("HandleAdClosed event received");
		ApiManager.instance.SendAppEvent ("BannerAdClosed");
	}
