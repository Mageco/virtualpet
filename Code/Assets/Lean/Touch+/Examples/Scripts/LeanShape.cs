...
namespace Lean.Touch
{
	...
	[HelpURL(LeanTouch.HelpUrlPrefix + "LeanShape")]
	[AddComponentMenu(LeanTouch.ComponentMenuPrefix + "Shape")]
	public class LeanShape : MonoBehaviour
	{
		...
		public void Gen()
		{
			...
			for (var i = 0; i < 8; i++)
			{
				var a = (Mathf.PI * 2.0f / 8.0f) * i;

				Points.Add(new Vector2(Mathf.Sin(a) * 5, Mathf.Cos(a) * 5));
			}
		}
