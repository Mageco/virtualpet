...
namespace Lean.Touch
{
	...
	public class LeanShapeDetector : MonoBehaviour
	{
		...
		[Tooltip("If the finger strays this many scaled pixels from the expected shape path, then the finger will be discarded.")]
		public float ErrorThreshold = 100.0f;
		...
		[Range(0.5f, 0.99f)]
		public float DirectionPrecision = 0.9f;
		...
		/// <summary>This allows you to begin shape detection for the specified finger.
		/// NOTE: This must be manually called from somewhere (e.g. the LeanFingerDown component).</summary>
