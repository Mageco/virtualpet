...
{
	/// <summary>This script shows you how you can check to see which part of the screen a finger is on, and work accordingly.</summary>
	public class LeanFingerShoot : MonoBehaviour
	{
		...
		private void FingerSet(LeanFinger finger)
		{
			...
			var leanFingerData = LeanFingerData.Find(fingerDatas, finger);
