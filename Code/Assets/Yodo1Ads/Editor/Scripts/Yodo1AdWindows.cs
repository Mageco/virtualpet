...
namespace Yodo1Ads
{
    public class Yodo1AdWindows : EditorWindow
    {
        ...
        private void DrawAndroidContent()
        {
            ...
            {
                EditorGUILayout.HelpBox("An empty AdMob App ID will cause a crash during initialization, you can find AdMob App ID on the MAS dashboard.", MessageType.Info);
            }
