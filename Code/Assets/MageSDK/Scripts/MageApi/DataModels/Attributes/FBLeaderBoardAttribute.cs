...
{
    [Serializable]
    public class FBLeaderBoardAttribute : Attribute
    {
        public const string target = "FBLeaderBoard";
        public const string fieldPrefix = "LeaderBoard_";
        public FBLeaderBoardAttribute() : base()
        {
        }
        ...
        public static UserData ExtractUserDataFields(object obj, string className, string memberName) {
            ...
            if (MageAttributeHelper.IsArrayMember(obj, memberName)) {
                ...
                ApiUtils.Log("Add leaderboard field: " + d.ToJson());
               return d;
            }
