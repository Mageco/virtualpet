...
namespace MageSDK.Client
{
    public class MageEngineSettings
    {
        ...
        public const string GAME_ENGINE_ENFORECED_ANDROID_SIGNATURE = "EnforcedAndroidSignature";
        ...
        public const string GAME_ENGINE_ADS_UNIT_CONFIGURAIONS = "AdsUnitConfigurations";
        public const string GAME_ENGINE_TIME_LAP_INTERSTITIAL = "TimeLapInterstitial";
