...
public enum SkillType {NONE,Toilet,Sleep,Bath,Toy,Happy};
...
public enum ActionType { None, Mouse, Sleep, Eat, Drink, Patrol, Discover, Pee, Shit, Itchi, Sick, Happy, Tired, Hold, OnTable, OnBath,Fall,Injured,Supprised,Stop,Toy,OnCall,OnControl,OnGift,Tease,Teased,Love,Init};
...
public enum AdDistribute {None,Unity,Admob, Yodo1MAS, IronSource};
